      ...
      <section className="relative flex flex-1 flex-col items-center justify-center py-24 md:py-32">
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            >
              <Link to="/reservasi">Lihat Jadwal</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-xl mx-auto font-medium">
              Kami menghadirkan fitur-fitur terbaik untuk kenyamanan aktivitas
              olahraga Anda
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-bold">
                {["Pesan Lapangan", "Member Eksklusif", "Kerjasama Mitra"].map(
                  (item) => (
                    <li key={item}>
                      <Link
                        to="/reservasi"
...
function FeatureCard({ icon, title, description, color = "primary" }) {
  const colorClasses = {
    primary:
      "bg-primary/10 text-primary border-primary/20 hover:shadow-primary/10",
    amber:
      "bg-amber-500/10 text-amber-500 border-amber-500/20 hover:shadow-amber-500/10",
    indigo:
      "bg-indigo-500/10 text-indigo-500 border-indigo-500/20 hover:shadow-indigo-500/10",
    emerald:
      "bg-emerald-500/10 text-emerald-500 border-emerald-500/20 hover:shadow-emerald-500/10",
  }[color];
  ...
  return (
    <div className="group relative overflow-hidden rounded-[2.5rem] transition-all duration-500 hover:-translate-y-2">
      ...
      <div className="relative z-10 p-10 space-y-6">
        <div
          className={`inline-flex h-16 w-16 items-center justify-center rounded-2xl shadow-inner transition-all duration-500 group-hover:scale-110 ${colorClasses}`}
        >
          {icon}
        </div>
